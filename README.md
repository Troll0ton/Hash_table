...
Первая часть проекта посвящена изучению работ различных хэш-функций. Необходимо исследовать эффективность работы хэш-функций на тексте - проанализировать распространенность коллизий в каждом отдельном списке хэш-таблицы. Все хэш-функции проверяются на трагедии Уильяма Шекспира "Трагическая история о Гамлете, принце датском", представленном на анлийском языке.
